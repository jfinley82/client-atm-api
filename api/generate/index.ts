...
Generate the complete micro-training system now.`
      ...
      const { data: generation, error } = await supabase
        ...
        .insert({
          ...
          book_a_call_emails: parsed.book_a_call_emails ?? [],
        })
        .select()
        .single()
