...
const KNOWN_KINDS: { kind: string; label: string; group: string; sequence_number: number; interval_label: string }[] = [
  ...
  { kind: 'reminder_1w', label: 'Reminder — 1 week', group: 'booking', sequence_number: 2, interval_label: '1 week before the call' },
  { kind: 'reminder_3d', label: 'Reminder — 3 days', group: 'booking', sequence_number: 3, interval_label: '3 days before the call' },
  { kind: 'reminder_24h', label: 'Reminder — 24 hours', group: 'booking', sequence_number: 4, interval_label: '24 hours before the call' },
  { kind: 'reminder_1h', label: 'Reminder — 1 hour', group: 'booking', sequence_number: 5, interval_label: '1 hour before the call' },
