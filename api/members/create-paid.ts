...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  return respondGone(req, res, {
    label: 'members/create-paid',
    useInstead: 'Paid grants arrive through api/stripe/webhook.ts. To provision by hand use POST /api/admin/members with the membership_tier you want.',
