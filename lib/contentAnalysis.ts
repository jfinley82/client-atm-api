...

{
  ...
  "emails": [
    { "id": "e1", "type": "Welcome", "subject": "a specific, non-generic subject line", "body": "a full, ready-to-send email body. Short paragraphs separated by a blank line, never one solid block." }
  ]
}
...
- Write each email BODY the same way: SHORT PARAGRAPHS of 1-3 sentences, each separated by a blank line (\\n\\n). Never one solid block. It is read on a phone, in an inbox, by someone deciding in the first two seconds whether to keep going. The greeting line and the sign-off are each their own paragraph.
